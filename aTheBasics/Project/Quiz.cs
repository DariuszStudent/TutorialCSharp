    ...
    public class Quiz
    {
        ...
        private void LoadQuestionFromFile(string filePath)
        {
            ...
            foreach (var line in lines)
            {
                ...
                if (counter == 0) currentQuestion.Title = line;
                if (counter == 1) currentQuestion.AnswerA = line;
                if (counter == 2) currentQuestion.AnswerB = line;
                if (counter == 3) currentQuestion.AnswerC = line;
                if (counter == 4) currentQuestion.AnswerD = line;
                if (counter == 5)
                {
        ...
        public int ShowQuestion(int questionCounter)
        {
            ...
            Console.WriteLine("Yout answer was wrong");
            return 0;
        }
    }
}
